...
namespace Exoa.Designer
{
    public class DataModel
    {
        ...
        {
            // IBMROS: A2 — optional stable identity (additive schema, R4: old saves have
            // null and get an id lazily on load). Foundation for write-through UI (A2),
            // gateway addressing (A3) and dirty-scoped rebuilds (A5).
            public string uniqueId;
