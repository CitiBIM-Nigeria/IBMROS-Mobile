...
namespace Exoa.Designer
{
    public class FloorController : MonoBehaviour
    {
        ...
        // IBMROS: A4 — was FindObjectOfType<Grid>() per call (hot path during rebuilds).
        // The grid never changes at runtime; cache it (cleared on scene load by Unity
        // destroying the static reference target -> null check re-resolves).
        private static Grid ibmrosCachedGrid;
        public Grid GetGrid()
        {
